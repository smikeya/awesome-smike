...
local gui_editor   = os.getenv("GUI_EDITOR") or "xed"
...
lain.layout.cascade.tile.offset_y      = dpi(28)
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "space", function () awful.util.spawn( "xfce4-appfinder" ) end,
        {description = "xfce app-finder" , group = "dmenu scripts" }),
    awful.key({ modkey,  }, "space", function () awful.util.spawn( "./.dotfiles/autoloaded/mrofi" ) end,
        {description = "rofi window select" , group = "dmenu scripts" }),
    ...
    awful.key({ modkey, altkey }, "a", function () awful.util.spawn( terminal.." -e ./scripts/pulsemixer" ) end,
        {description = "pulsemixer" , group = "terminal apps" }),
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn( "palemoon www.youtube.com/c/DistroTube" ) end,
        {description = "palemoon web browser" , group = "gui apps" }),
    ...
    awful.key({ modkey, "Shift" }, "w", function () lain.util.rename_tag() end,
              {description = "rename tag", group = "tag"}),
    awful.key({ modkey, "Shift"   }, "a", copy_tag,
    ...
    -- Widgets popups
    awful.key({ altkey, "Shift" }, "w", function () if beautiful.cal then beautiful.cal.show(7) end end,
...
--),
    awful.key({ modkey, "Mod1"    }, "F4",
        ...
        {description = "reize Right", group = "client"}),
    awful.key({ modkey, "Mod1"    }, "F5",
        function ()
            awful.client.incwfact(-0.01)
        end,
        {description = "reize UP", group = "client"}),
    awful.key({ modkey, "Mod1"    }, "F6",
        function ()
            awful.client.incwfact( 0.01)
        end,
...
-- awful.spawn.with_shell("setxkbmap -layout 'us,ru' -option 'grp:ctrls_toggle,grp_led:scroll',caps:escape")
-- awful.spawn.with_shell("nitrogen --restore")
-- awful.spawn.with_shell("compton --config  $HOME/.config/compton/compton.conf")
-- awful.spawn.with_shell("nm-applet")
 awful.spawn.with_shell("volumeico:with_shelln")
